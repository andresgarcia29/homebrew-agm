...
class Harness < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/andresgarcia29/harness-daemon/releases/download/v0.55.1/harnessd-darwin-arm64"
      sha256 "d2c41e278f8cca70b2b7698508f870bcf914f2ddbc0939f27ec76ea0b7c90cc2"
    else
      url "https://github.com/andresgarcia29/harness-daemon/releases/download/v0.55.1/harnessd-darwin-amd64"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/andresgarcia29/harness-daemon/releases/download/v0.55.1/harnessd-linux-arm64"
      sha256 "2ef7d46dacec517af0f1d3dfc736ea06732f57ab851751a49af0f60db3dbd5d7"
    else
      url "https://github.com/andresgarcia29/harness-daemon/releases/download/v0.55.1/harnessd-linux-amd64"
  ...
  test do
    assert_match "0.55.1", shell_output("#{bin}/harness version")
  end
end
